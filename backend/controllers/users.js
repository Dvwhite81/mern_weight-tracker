...
usersRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield user_1.default.find({}).populate('weights');
    res.json(users);
}));
// Get User by Token
...
usersRouter.get('/:username/weights', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// Delete Weight
usersRouter.put('/:username/weights/:weightId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
